...
public class MailSenderService {
	...
	public void sendAuthMail(String mail, String id) {
		...
		htmlContent.append("현재 " + id + " 회원님은 최종 로그인 시간으로부터 1년의 시간이 경과하여 /n");
		htmlContent.append("냉장고를 부탁해 사이트의 개인정보 보호 기간이 만료하고 있음을 알려드리며 /n");
		htmlContent.append("1주일 안으로 로그인하지 않을시/n");
		htmlContent.append("회원님과 관련된 모든 정보가 삭제됨을 알려드립니다./n");
