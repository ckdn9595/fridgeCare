...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:20px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m9">
      	...
      	<form method="POST" action="/fri/juhyun/partner/partnerCnt.fri" class="w3-container w3-card w3-round w3-margin-bottom w3-margin-left w3-margin-right w3-border" id="frm">
				...
				<div class="w3-col w3-border">
					...
					<div class="w3-col m9">
						<div class="w3-col" style="height: 71px;">
							...
							<h4 class="w3-col m4 w3-margin-top">작성일 : ${board.bdate}</h4>
						</div>
						<div class="w3-col" style="height: 71px;">
